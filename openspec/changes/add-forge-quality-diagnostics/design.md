...
The `0.0625` lower bound (= 1/16) is the rule-of-thumb breakpoint where compression reaches "you're effectively forging a constant model" territory. Specific to residual-stream LMs; the spec documents it as adjustable.
